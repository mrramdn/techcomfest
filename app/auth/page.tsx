...
function AuthPageContent() {
  ...
  return (
    <main className="relative h-screen overflow-hidden flex">
      ...
      {/* Left Panel - Form */}
      <div className="relative w-full md:w-1/2 h-full overflow-hidden md:rounded-br-4xl md:rounded-tr-4xl bg-white px-6 md:px-24 py-11 flex items-center justify-center z-10">
        <div className="w-full max-w-md flex flex-col gap-7">
          ...
          {/* Tab Switch */}
          <div className="h-11 rounded-xl outline -outline-offset-1 outline-gray-300 p-1 inline-flex gap-1 w-full">
            <button
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <div className="h-12 rounded-xl bg-slate-200 px-3.5 py-3 outline -outline-offset-1 outline-gray-300 flex items-center justify-between">
                <input
                  type="email"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  placeholder="enter your email"
                  className="flex-1 bg-transparent text-gray-900 placeholder:text-gray-500 text-base font-normal leading-6 outline-none"
                  required
                />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="h-12 rounded-xl bg-slate-200 px-4 py-4 outline -outline-offset-1 outline-gray-300 flex items-center justify-between gap-2">
                <input
                ...
                <button
                  ...
                  className="text-gray-500 hover:text-gray-700 transition-colors h-6"
                >
            ...
            {mode === "signin" && (
              <div className="flex items-center justify-between">
                ...
                <a
                  href="/auth/forgot"
                  className="text-blue-500 text-sm font-normal leading-5 hover:underline transition-all"
                >
                  Forgot password?
                </a>
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="h-12 rounded-xl bg-slate-200 px-4 py-4 outline -outline-offset-1 outline-gray-300 flex items-center justify-between gap-2">
                  ...
                  <button
                    ...
                    className="text-gray-500 hover:text-gray-700 transition-colors items-center h-6"
                  >
                    <span className="material-symbols-outlined text-xl">
          ...
          <div className="inline-flex items-center gap-4 w-full">
            ...
            <div className="text-center text-gray-400 text-base leading-6">
              Or
            </div>
            <div className="flex-1 border-t border-gray-300" />
          </div>
          ...
          <div className="flex flex-col gap-3">
            <button className="rounded-xl bg-gray-200 py-2.5 w-full outline -outline-offset-1 outline-gray-300 inline-flex items-center justify-center gap-2.5 hover:bg-gray-50 transition-colors cursor-pointer">
              ...
              <div className="text-center text-gray-700 text-base font-medium leading-6">
                Log in with google
              </div>
            </button>
