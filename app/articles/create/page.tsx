...
import type { ArticleCategory, ArticleStatus } from "../_lib/articleTypes";
...
function CreateArticleContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      else if (thumbnailImage) form.append("thumbnailImage", thumbnailImage);

      if (heroFile) form.append("hero", heroFile);
      else if (heroImage) form.append("heroImage", heroImage);
      ...
      if (!res.ok) {
        ...
        setMessage(err?.error || "Failed to create article");
        return;
      }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-5 pb-16">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Create New Article</h1>
